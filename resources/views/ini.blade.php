...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      <h1 class="mt-5">Tarea 2.6</h1>
      <p class="lead">Cada grupo deberá realizar un pequeño resumen sobre algunos conceptos de Laravel. Para ello crearéis una vista siguiendo esta plantilla mostrada y modificando solamente el cuerpo de la página (este contenedor).</p>
